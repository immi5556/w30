...
public class ShimmerFrameLayout extends FrameLayout {
  ...
  /**
   * Get the shape of the current animation's highlight mask. One of {@link within30.com.utilities.ShimmerFrameLayout.MaskShape#LINEAR} or
   * {@link within30.com.utilities.ShimmerFrameLayout.MaskShape#RADIAL}
   *
  ...
  /**
   * Set the shape of the animation's highlight mask. One of {@link within30.com.utilities.ShimmerFrameLayout.MaskShape#LINEAR} or {@link within30.com.utilities.ShimmerFrameLayout.MaskShape#RADIAL}
   *
   ...
   * <ul>
   * <li>{@link within30.com.utilities.ShimmerFrameLayout.MaskAngle#CW_0} which animates left to right,</li>
   * <li>{@link within30.com.utilities.ShimmerFrameLayout.MaskAngle#CW_90} which animates top to bottom,</li>
   * <li>{@link within30.com.utilities.ShimmerFrameLayout.MaskAngle#CW_180} which animates right to left, or</li>
   * <li>{@link within30.com.utilities.ShimmerFrameLayout.MaskAngle#CW_270} which animates bottom to top</li>
   * </ul>
   *
   * @return The {@link within30.com.utilities.ShimmerFrameLayout.MaskAngle} of the current animation
   */
   ...
   * </ul>
   *
   * @param angle The {@link within30.com.utilities.ShimmerFrameLayout.MaskAngle} of the new animation
   */
   ...
   * is half the size of the corresponding edge (depending on the {@link within30.com.utilities.ShimmerFrameLayout.MaskAngle}), centered in the layout.
   *
   * @param dropoff
   */
