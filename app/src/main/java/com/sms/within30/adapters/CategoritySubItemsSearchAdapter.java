 ...
 */
public class CategoritySubItemsSearchAdapter extends ArrayAdapter<String> implements
        Filterable {
    ...
    public CategoritySubItemsSearchAdapter(Context context, int resource,
